...
public class ExchangeRateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            BigDecimal rateNumber = PathUtils.extractRate(rate);

            log.info("Base Currency = {}", baseCurrencyCode);
            log.info("Target Currency = {}", targetCurrencyCode);
            CurrencyRequestDto baseCurrencyRequestDto = CurrencyRequestDto.of(null, baseCurrencyCode, null);
            CurrencyRequestDto targetCurrencyRequestDto = CurrencyRequestDto.of(null, targetCurrencyCode, null);

            ExchangeRateRequestDto rateRequestDto = new ExchangeRateRequestDto(baseCurrencyRequestDto, targetCurrencyRequestDto, rateNumber);

            exchangeRatesService.createExchangeRates(rateRequestDto);

        }catch (ValidationRateException e){
